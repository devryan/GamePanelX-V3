...
(3, 3, 27015, 24, 1, 1, 'game', ' ', 'source', 'Counter-Strike: Condition Zero', 'cs_cz', 'czero', '', '+- ', 'ip', 'port', 'maxplayers', 'map', 'hostname', 'rcon_password', 'sv_password', 'de_dust2_cz', 'New GamePanelX Server', 'cstrike/cfg/server.cfg', 'czero', 'Update of CS:1.6 with bots and missions', '', '', './steam -command update -game czero -dir .', './hlds_run -game cstrike +ip %IP% +port %PORT% +map de_dust +maxplayers 16'),
...
(5, 7, 27015, 24, 1, 2, 'game', ' ', 'source', 'Counter-Strike: GO', 'cs_go', 'csgo', '', '+- ', 'ip', 'port', 'maxplayers', 'map', 'hostname', 'rcon_password', 'sv_password', 'de_dust2', 'New GamePanelX Server', 'cfg/server.cfg', '740', 'Counter-Strike: Global Offensive', '', '', 'export LD_LIBRARY_PATH=linux32/ && STEAMEXE=steamcmd ./steam.sh +runscript .gpxsteamupdate.txt', ''),
(6, 8, 27015, 24, 1, 1, 'game', ' ', 'tf2', 'Team Fortress 2', 'tf2', 'orangebox', '', '+- ', 'ip', 'port', 'maxplayers', 'map', 'hostname', 'rcon_password', 'sv_password', 'cp_badlands', 'New GamePanelX Server', '', 'tf', 'Free to play update of Team Fortress', '', '', './steam -command update -game tf -dir .', ''),
