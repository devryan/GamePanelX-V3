...
(7, 9, 7777, 8, 0, 0, 'game', ' ', 'samp', 'GTA: San Andreas MP', 'gta_samp', '', '', '', 'bind', 'port', 'maxplayers', 'mapname', 'hostname', 'rcon_password', 'password', '', 'New GamePanelX Server', 'server.cfg', '', '', 'http://files.sa-mp.com/samp03xsvr_R2_patch1.tar.gz', 'tar -zxf samp03xsvr_R2_patch1.tar.gz\r\nrm -f samp03xsvr_R2_patch1.tar.gz\r\nmv samp03/* .\r\nrmdir samp03\r\nrand_pass=$(tr -dc "[:alpha:]" < /dev/urandom | head -c 8)\r\nsed -i "s/rcon_password\\ changeme/rcon_password\\ \\$rand_pass/g" server.cfg\r\nsed -i s/hostname\\ SA\\-MP\\ 0\\.3\\ Server/hostname\\ New\\ GamePanelX\\ Server/g server.cfg', '', './samp03svr'),
