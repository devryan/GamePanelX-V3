...
INSERT INTO `default_games` (`id`, `cloudid`, `port`, `startup`, `steam`, `gameq_name`, `name`, `intname`, `working_dir`, `pid_file`, `steam_name`, `description`, `update_cmd`, `simplecmd`) VALUES
('', 2, 27015, 1, 1, 'source', 'Counter-Strike: 1.6', 'cs_16', '', '', 'cstrike', '', '', './hlds_run -game cstrike +ip %IP% +port %PORT% +map de_dust2 +maxplayers 16'),
('', 4, 3784, 1, 0, 'ventrilo', 'Ventrilo', 'vent', '', 'ventrilo_srv.pid', '', 'Voice Communication Server', '', './ventrilo_srv -d'),
('', 3, 27015, 1, 1, 'source', 'Counter-Strike: Condition Zero', 'cs_cz', 'czero', '', 'czero', 'Update of CS:1.6 with bots and missions', '', './hlds_run -game cstrike +ip %IP% +port %PORT% +map de_dust +maxplayers 16'),
...
('', 0, 27015, 1, 1, 'source', 'Counter-Strike: GO', 'cs_go', 'csgo', '', 'csgo', 'Counter-Strike: Global Offensive', 'export LD_LIBRARY_PATH=linux32/ && STEAMEXE=steamcmd ./steam.sh +runscript update.txt', './srcds_run -game csgo -ip %IP% -port %PORT% +map de_dust2 +sv_pure 0 +mapgroup mg_bomb -tickrate 66 +maxplayers 12 -maxplayers_override 12 +net_public_adr %IP% +game_type 0 +game_mode 1 +sv_steamgroup_exclusive 1 -console -usercon '),
('', 5, 16567, 1, 0, 'bf2', 'Battlefield 2', 'bf2', '', '', '', 'Next iteration in the Battlefield series', '', './start.sh'),('', 0, 25585, 1, 0, '', 'Minecraft', 'mcraft', '', '', '', 'CraftBukkit Minecraft Server', '', 'java -Xincgc -Xmx1000M -jar craftbukkit.jar nogu');
