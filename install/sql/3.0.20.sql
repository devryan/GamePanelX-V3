CREATE TABLE IF NOT EXISTS `admins` (
  ...
  `exit_warn` tinyint(1) NOT NULL DEFAULT 1,
  PRIMARY KEY (`id`),
...
(9, 6, 25565, 8, 0, 0, 'game', '=', 'minecraft', 'Minecraft', 'mcraft', '', '', '', 'server-ip', 'server-port', 'max-players', 'level-name', 'motd', 'enable-rcon', '', '', 'New GamePanelX Server', 'server.properties', '', 'CraftBukkit Minecraft Server', 'http://dl.bukkit.org/latest-rb/craftbukkit.jar', 'mv craftbukkit* craftbukkit.jar', '', 'java -Xincgc -Xmx1000M -jar craftbukkit.jar nogui'),
