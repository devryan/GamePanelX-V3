...
elseif($url_do == 'save')
{
    ...
    @mysqli_query($connection, "UPDATE admins SET last_updated = NOW(),username = '$url_username',theme = '$url_theme',language = '$url_language',email_address = '$url_email',first_name = '$url_first_name',last_name = '$url_last_name'$sql_pass WHERE id = '$url_id'") or die('Failed to update admin');
...
elseif($url_do == 'delete')
{
    ...
    @mysqli_query($connection, "UPDATE admins SET deleted = '1' WHERE id = '$url_id'") or die('Failed to delete the admin');
