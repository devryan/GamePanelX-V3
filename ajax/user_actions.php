...
elseif($url_do == 'save_perms')
{
    ...
    // Admins only
    if(isset($_SESSION['gpx_admin'])) @mysqli_query($connection, "UPDATE users SET perm_ftp = '$perm_ftp',perm_files = '$perm_files',perm_startup = '$perm_startup',perm_chpass = '$perm_chpass',perm_updetails = '$perm_updetails' WHERE id = '$url_id'") or die('Failed to update permissions!');
