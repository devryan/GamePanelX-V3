...
$result_usr = @mysqli_query("SELECT 
                            ...
                            WHERE 
                              id = '$url_id' 
                            LIMIT 1") or die('Failed to query for admins: '.mysqli_error());
...
$tab  = 'info';
include(DOCROOT.'/ajax/admin_tabs.php');
?>
...
if($this_userid != $url_id)
{
?>
<tr>
  <td width="180"><b><?php echo $lang['delete']; ?>:</b></td>
  <td><span class="links" onClick="javascript:admin_confirm_delete(<?php echo $url_id; ?>);"><?php echo $lang['click_here']; ?></span></td>
</tr>
<tr>
  <td colspan="2">&nbsp;</td>
</tr>
...
<tr>
  ...
  <td><input type="text" value="<?php echo $usr_usrname; ?>" id="adm_username" class="inputs" /></td>
</tr>
<tr>
  <td><b><?php echo $lang['language']; ?>:</b></td>
  <td>
    <select id="adm_language" class="dropdown">
      <?php
      // No lang yet
...
<tr>
  ...
  <td>
    <select id="adm_theme" class="dropdown">
      <?php
...
<tr>
  ...
  <td><input type="password" id="adm_pass1" class="inputs" /></td>
</tr>
<tr>
  <td><?php echo $lang['newpassword_conf']; ?>:</td>
  <td><input type="password" id="adm_pass2" class="inputs" /></td>
</tr>
...
<tr>
  ...
  <td><input type="text" value="<?php echo $usr_email; ?>" id="adm_email" class="inputs" /></td>
</tr>
<tr>
  <td><b><?php echo $lang['first_name']; ?>:</b></td>
  <td><input type="text" value="<?php echo $usr_fname; ?>" id="adm_fname" class="inputs" /></td>
</tr>
<tr>
  <td><b><?php echo $lang['last_name']; ?>:</b></td>
  <td><input type="text" value="<?php echo $usr_lname; ?>" id="adm_lname" class="inputs" /></td>
</tr>
...
<div align="center">
  <div class="button" onClick="javascript:admin_save(<?php echo $url_id; ?>);"><?php echo $lang['save']; ?></div>
</div>
