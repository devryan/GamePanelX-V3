...
class Admins
{
    ...
    public function create($username,$password,$email,$first_name,$last_name)
    {
        ...
        $result_ck  = @mysqli_query("SELECT id FROM admins WHERE username = '$username' LIMIT 1");
        ...
        @mysqli_query("INSERT INTO admins (date_created,username,password,email_address,first_name,last_name) VALUES(NOW(),'$username','$password','$email','$first_name','$last_name')") or die('Failed to create user: '.mysqli_error());
